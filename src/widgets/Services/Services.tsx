...
const services: ServiceItem[] = [
    ...
    },
    {
        id: "pc-setup",
        title: "Настройка ПК",
        description: "Профессиональная настройка и оптимизация компьютеров. Установка ОС, настройка программ, решение технических проблем.",
        features: [
        ...
        >
            ...
            <div className="flex flex-col gap-4">
                <header className="flex flex-col gap-2 text-center">
                    ...
                    >
                        Разработка ПО, создание веб-сайтов, настройка ПК и техническое консультирование
                        <br />
