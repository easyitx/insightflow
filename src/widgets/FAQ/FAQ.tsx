...
Условия поддержки обсуждаются отдельно и могут быть включены в договор.`,
    ...
    {
        id: "item-5",
        question: "Что включает в себя настройка ПК?",
        answer: `Услуга настройки ПК включает:

• Установка и настройка операционной системы (Windows, Linux)
• Установка необходимого программного обеспечения
• Настройка драйверов и периферийных устройств
• Оптимизация производительности системы
• Настройка безопасности и антивирусной защиты
• Диагностика и устранение неполадок
• Настройка сети и интернет-соединения

Могу работать как удаленно, так и с выездом (в зависимости от региона).`,
    },
    {
        id: "item-6",
