...
Условия поддержки обсуждаются отдельно и могут быть включены в договор.`,
    },
    {
        ...
        answer: "Да, работаю удалённо с клиентами по всему миру. Все этапы — обсуждение, демонстрация промежуточных результатов и сдача проекта — проходят онлайн через Telegram, видеозвонки и общий доступ к репозиторию.",
    },
    {
        id: "item-6",
