...
Точную цену называю после обсуждения задачи. Работа напрямую с разработчиком — без наценки IT-студии на менеджеров и офис. Первая консультация бесплатная.`,
    },
    {
        ...
        answer: `В студии вы платите за процесс: менеджеров, офис, маркетинг и несколько исполнителей. Здесь — прямая работа с разработчиком, который сам пишет код и принимает решения. Это быстрее, прозрачнее по цене и без потери контекста при передаче между отделами.`,
    },
    {
        id: "item-1",
